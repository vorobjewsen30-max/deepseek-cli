#!/usr/bin/env python3
"""Stage and optionally package the deepseek-cli npm module."""
...
CODEX_NPM_NAME = "deepseek-cli"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `deepseek-cli`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "deepseek-cli-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "deepseek-cli-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "deepseek-cli-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "deepseek-cli-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "deepseek-cli-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "deepseek-cli-win32-arm64",
        "npm_tag": "win32-arm64",
...
PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    ...
    "deepseek-responses-api-proxy": ["deepseek-responses-api-proxy"],
    "codex-sdk": [],
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the DeepSeek CLI npm package.")
    parser.add_argument(
        "--package",
...
def main() -> int:
    ...
    try:
        ...
        if release_version:
            ...
            elif package == "deepseek-responses-api-proxy":
                print(
                    f"Staged version {version} for release in {staging_dir_str}\n\n"
                    "Verify the responses API proxy:\n"
                    f"    node {staging_dir_str}/bin/deepseek-responses-api-proxy.js --help\n\n"
                )
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex":
        ...
        bin_dir = staging_dir / "bin"
        bin_dir.mkdir(parents=True, exist_ok=True)
        launcher_src = RESPONSES_API_PROXY_NPM_ROOT / "bin" / "deepseek-responses-api-proxy.js"
        shutil.copy2(launcher_src, bin_dir / "deepseek-responses-api-proxy.js")
