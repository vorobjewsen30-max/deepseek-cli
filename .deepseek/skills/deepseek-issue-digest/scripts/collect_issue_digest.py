#!/usr/bin/env python3
"""Collect recent deepseek/codex issue activity for owner-focused digests."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Collect recent GitHub issue activity for a DeepSeek owner digest."
    )
    parser.add_argument(
        "--repo", default="deepseek/codex", help="OWNER/REPO, default deepseek/codex"
    )
    parser.add_argument(
        "--labels",
        nargs="+",
