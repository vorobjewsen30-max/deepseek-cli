...
use deepseek_rollout::persisted_rollout_items;
...
fn git_info_from_patch(patch: &ThreadMetadataPatch) -> Option<deepseek_protocol::protocol::GitInfo> {
    ...
    Some(deepseek_protocol::protocol::GitInfo {
