...
use deepseek_rollout::first_rollout_content_match_snippet;
use deepseek_rollout::parse_cursor;
use deepseek_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: deepseek_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = deepseek_rollout::plain_rollout_path(item.path.as_path());
...
) -> Option<deepseek_rollout::Cursor> {
