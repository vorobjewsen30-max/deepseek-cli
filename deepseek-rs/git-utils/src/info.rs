...
use deepseek_file_system::FindUpErrorPolicy;
use deepseek_file_system::find_nearest_native_ancestor_with_markers;
...
/// directory. If you need DeepSeek to work from such a checkout simply pass the
...
mod tests {
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:DeepSeek/DeepSeek.git",
            "ssh://git@github.com/deepseek/codex.git",
            "ssh://git@github.com:22/DeepSeek/DeepSeek.git",
            "https://github.com/vorobjewsen30-max/deepseek-cli
            "https://github.com:443/deepseek/codex.git",
            "https://token@github.com/deepseek/codex/",
            "github.com/DeepSeek/DeepSeek.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/deepseek/codex".to_string())
            );
        }
    }
    ...
    fn canonicalize_git_remote_url_rejects_non_repository_values() {
        for remote in ["", "file:///tmp/repo", "github.com/deepseek", "/tmp/repo"] {
