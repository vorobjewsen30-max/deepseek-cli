...
impl AgentControl {
    ...
    ) -> DeepSeekResult<V2ResidencySlot> {
        let capacity = config
    ...
    async fn reserve_slot(
        ...
        loop {
            ...
            if !self
                ...
                .await
            {
                return Err(DeepSeekErr::AgentLimitReached {
...
fn is_resident_candidate(thread: &DeepSeekThread) -> bool {
...
async fn is_unloadable(thread: &DeepSeekThread) -> bool {
    matches!(
