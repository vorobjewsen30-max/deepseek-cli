...
use deepseek_protocol::protocol::CONTEXT_WINDOW_CLOSE_TAG;
use deepseek_protocol::protocol::CONTEXT_WINDOW_GUIDANCE_CLOSE_TAG;
...
fn skips_unnamed_image_label_text() {
    let image_url = "data:image/png;base64,abc".to_string();
    let label = deepseek_protocol::models::image_open_tag_text();
    let user_text = "Please review this image.".to_string();
    ...
    let item = ResponseItem::Message {
        ...
        content: vec![
            ...
            ContentItem::InputText {
                text: deepseek_protocol::models::image_close_tag_text(),
            },
            ContentItem::InputText {
                text: user_text.clone(),
            },
