use deepseek_core_skills::AvailableSkills;
use deepseek_core_skills::SKILLS_HOW_TO_USE_WITH_ABSOLUTE_PATHS;
use deepseek_core_skills::SKILLS_HOW_TO_USE_WITH_ALIASES;
use deepseek_core_skills::render_available_skills_body;
...
/// Model-context fragment describing the skills available to DeepSeek.
