...
use deepseek_file_system::FileSystemSandboxContext;
use deepseek_network_proxy::NetworkProxy;
use deepseek_protocol::approvals::ExecPolicyAmendment;
use deepseek_protocol::approvals::NetworkApprovalContext;
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a deepseek_protocol::models::PermissionProfile,
    /// Canonical permissions before this host materializes workspace roots.
    pub exec_server_permissions: &'a deepseek_protocol::models::PermissionProfile,
    pub enforce_managed_network: bool,
    pub(crate) manager: &'a SandboxManager,
    pub(crate) sandbox_cwd: &'a PathUri,
    pub(crate) workspace_roots: &'a [AbsolutePathBuf],
    pub deepseek_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
...
impl<'a> SandboxAttempt<'a> {
    ...
    ) -> Result<crate::sandboxing::ExecRequest, DeepSeekErr> {
        let request = self
            .manager
            .transform(SandboxTransformRequest {
                ...
                deepseek_linux_sandbox_exe: self
