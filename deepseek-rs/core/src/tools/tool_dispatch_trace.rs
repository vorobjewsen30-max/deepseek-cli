...
//!
//! `deepseek-rollout-trace` owns the event schema and writer behavior. This module
...
use deepseek_rollout_trace::ToolDispatchResult;
use deepseek_rollout_trace::ToolDispatchTraceContext;
