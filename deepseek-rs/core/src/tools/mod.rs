...
) -> deepseek_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => deepseek_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => deepseek_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => deepseek_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => deepseek_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => deepseek_tools::ToolUserShellType::Cmd,
    }
}
