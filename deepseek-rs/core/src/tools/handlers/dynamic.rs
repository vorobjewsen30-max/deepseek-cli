...
use deepseek_protocol::dynamic_tools::DynamicToolCallRequest;
...
use deepseek_tools::ToolSearchSourceInfo;
use deepseek_tools::ToolSpec;
use deepseek_tools::default_namespace_description;
use deepseek_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_tool_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current DeepSeek thread.".to_string()),
            }),
        )
    }
