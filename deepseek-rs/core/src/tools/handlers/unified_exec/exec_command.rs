...
impl ExecCommandHandler {
    async fn handle_call(
        ...
        let command_for_display = deepseek_shell_command::parse_command::shlex_join(&command);
        ...
        if effective_additional_permissions
            ...
            && !matches!(
                ...
                deepseek_protocol::protocol::AskForApproval::OnRequest
            )
        {
