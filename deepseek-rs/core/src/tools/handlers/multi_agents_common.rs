...
use deepseek_protocol::protocol::CollabAgentRef;
use deepseek_protocol::protocol::CollabAgentStatusEntry;
...
pub(crate) fn collab_spawn_error(err: DeepSeekErr) -> FunctionCallError {
    match err {
        DeepSeekErr::UnsupportedOperation(message) if message == "thread manager dropped" => {
            FunctionCallError::RespondToModel("collab manager unavailable".to_string())
        }
        DeepSeekErr::UnsupportedOperation(message) => FunctionCallError::RespondToModel(message),
        err => FunctionCallError::RespondToModel(format!("collab spawn failed: {err}")),
    }
}

pub(crate) fn collab_agent_error(agent_id: ThreadId, err: DeepSeekErr) -> FunctionCallError {
    match err {
        DeepSeekErr::ThreadNotFound(id) => {
...
fn find_spawn_agent_model_name(
    available_models: &[deepseek_protocol::deepseek_models::ModelPreset],
    requested_model: &str,
