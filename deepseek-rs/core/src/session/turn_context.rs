...
use deepseek_sandboxing::policy_transforms::effective_network_sandbox_policy;
...
pub struct TurnContext {
    ...
    pub(crate) extension_data: Arc<deepseek_extension_api::ExtensionData>,
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            deepseek_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(deepseek_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    ) -> DeepSeekResult<Arc<TurnContext>> {
        let notify_config_contributors = !self.services.extensions.config_contributors().is_empty();
        let update_result: DeepSeekResult<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                ...
                Err(err) => Err(DeepSeekErr::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (session_configuration, permission_profile_changed, previous_config, new_config) =
            match update_result {
                ...
                Err(err) => {
                    ...
                    .await;
                    return Err(DeepSeekErr::InvalidRequest(message));
                }
            };
