...
use deepseek_connectors::PluginConnectorSource;
...
use deepseek_mcp::DeepSeekAppsToolsCache;
use deepseek_mcp::EffectiveMcpServer;
use deepseek_mcp::McpConfig;
use deepseek_mcp::McpPluginAttribution;
use deepseek_mcp::McpServerRegistration;
use deepseek_mcp::codex_apps_mcp_server_config;
use deepseek_mcp::configured_mcp_servers;
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            deepseek_extension_api::empty_extension_registry(),
        )
    }
    ...
    pub fn new_with_extensions(
        ...
        Self {
            plugins_manager,
            extensions,
            codex_apps_tools_cache: DeepSeekAppsToolsCache::default(),
        }
    }

    pub fn codex_apps_tools_cache(&self) -> DeepSeekAppsToolsCache {
