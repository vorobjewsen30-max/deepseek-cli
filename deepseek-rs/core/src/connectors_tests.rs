...
use deepseek_config::AppRequirementToml;
use deepseek_config::AppsRequirementsToml;
...
use deepseek_connectors::merge::plugin_connector_to_app_info;
use deepseek_connectors::metadata::connector_install_url;
use deepseek_connectors::metadata::sanitize_name;
    ...
    assert_eq!(
        ...
        vec![
            ...
            AppInfo {
                ...
                icon_dark_assets: None,
                distribution_channel: None,
                install_url: Some(connector_install_url("Hidden", "connector_deepseek_hidden")),
                branding: None,
                app_metadata: None,
                labels: None,
                is_accessible: true,
