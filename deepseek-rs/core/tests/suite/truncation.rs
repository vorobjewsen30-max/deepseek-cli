    ...
    let mut builder = test_codex().with_config(move |config| {
        ...
        servers.insert(
            ...
            deepseek_config::types::McpServerConfig {
                ...
                transport: deepseek_config::types::McpServerTransportConfig::Stdio {
...
async fn mcp_image_output_preserves_image_and_no_text_summary() -> Result<()> {
    ...
    // 1x1 PNG data URL
    let deepseek_png = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR4nGP4z8DwHwAFAAH/iZk9HQAAAABJRU5ErkJggg==";
    ...
    assert_eq!(
        arr[1],
        json!({"type": "input_image", "image_url": deepseek_png, "detail": "high"})
    );
