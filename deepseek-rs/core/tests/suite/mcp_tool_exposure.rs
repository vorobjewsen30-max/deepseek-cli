...
-> Result<()> {
    ...
    tokio::fs::remove_dir_all(test.deepseek_home_path().join("cache/codex_apps_tools")).await?;
    ...
    let refresh_config = McpServerRefreshConfig {
        mcp_servers: serde_json::to_value(deepseek_mcp::configured_mcp_servers(&runtime_mcp_config))?,
