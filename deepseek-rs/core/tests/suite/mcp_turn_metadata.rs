...
use deepseek_protocol::protocol::ElicitationAction;
...
fn set_calendar_approval_mode(config: &mut Config, approval_mode: AppToolApproval) {
    ...
    let user_config_path = config.deepseek_home.join("config.toml").abs();
        ...
        .submit(Op::UserInput {
            ...
            thread_settings: deepseek_protocol::protocol::ThreadSettingsOverrides {
                ...
                collaboration_mode: collaboration_mode.or({
                    Some(deepseek_protocol::config_types::CollaborationMode {
