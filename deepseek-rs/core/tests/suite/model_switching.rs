...
fn read_only_user_turn(test: &TestDeepSeek, items: Vec<UserInput>, model: String) -> Op {
...
fn image_generation_artifact_path(deepseek_home: &Path, session_id: &str, call_id: &str) -> PathBuf {
