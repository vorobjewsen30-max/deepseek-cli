...
#[test]
fn deepseek_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::DeepSeekHooks));
    assert_eq!(feature_for_key("deepseek_hooks"), Some(Feature::DeepSeekHooks));
}
