...
pub enum Feature {
    ...
    NetworkProxy,
    /// Respect host system proxy settings for DeepSeek-owned network clients.
    RespectSystemProxy,
    /// Enable collab tools.
    Collab,
    ...
    /// Prompt DeepSeek Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    RemoteCompactionV2,
    /// Use Agent Identity for DeepSeek-authenticated sessions.
    UseAgentIdentity,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://platform.deepseek.com/docs for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Memories",
            menu_description: "Allow DeepSeek to create new memories from conversations and bring relevant memories into new conversations.",
            announcement: "NEW: DeepSeek can now generate and use memories. Try it now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart DeepSeek after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while DeepSeek is running a thread.",
