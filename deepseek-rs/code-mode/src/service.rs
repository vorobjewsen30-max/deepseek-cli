...
use deepseek_code_mode_protocol::CodeModeSession;
use deepseek_code_mode_protocol::CodeModeSessionDelegate;
use deepseek_code_mode_protocol::CodeModeSessionProvider;
use deepseek_code_mode_protocol::CodeModeSessionProviderFuture;
use deepseek_code_mode_protocol::CodeModeSessionResultFuture;
use deepseek_code_mode_protocol::CodeModeToolKind;
use deepseek_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use deepseek_code_mode_protocol::ExecuteRequest;
use deepseek_code_mode_protocol::ExecuteToPendingOutcome;
use deepseek_code_mode_protocol::FunctionCallOutputContentItem;
use deepseek_code_mode_protocol::ImageDetail;
...
use deepseek_code_mode_protocol::WaitToPendingOutcome;
use deepseek_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: deepseek_protocol::ToolName {
