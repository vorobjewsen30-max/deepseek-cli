...
mod tests {
    ...
    fn evaluate_returns_first_matching_hook() {
        ...
        first.matcher.path_prefixes = vec!["/repos/deepseek/".to_string()];
        ...
        let req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/codex/issues")
            .header("x-trace", "1")
            .body(Body::empty())
            .unwrap();
    ...
    fn evaluate_matches_query_and_header_constraints() {
        ...
        let req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/codex/issues?state=open&per_page=10")
    ...
    fn evaluate_matches_wildcard_path_query_and_header_constraints() {
        ...
        let req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/codex/issues?state=open")
    ...
    fn evaluate_path_wildcard_does_not_cross_segment_boundaries() {
        ...
        let nested_req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/private/codex/issues")
            .body(Body::empty())
            .unwrap();
    ...
    fn evaluate_allows_literal_values_with_reserved_prefixes() {
        ...
        let exact_req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/codex/issues?state=pattern%3A%2A")
            .header("x-github-api-version", "pattern:*")
            .body(Body::empty())
            .unwrap();
        let non_literal_req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/codex/issues?state=pattern%3Aopen")
    ...
    fn evaluate_returns_hooked_host_no_match_when_query_constraint_fails() {
        ...
        let req = Request::builder()
            .method(Method::POST)
            .uri("/repos/deepseek/codex/issues?state=closed")
            .body(Body::empty())
            .unwrap();
