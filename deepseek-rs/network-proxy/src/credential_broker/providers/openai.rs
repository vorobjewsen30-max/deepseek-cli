...
const DEEPSEEK_API_KEY_MIN_LEN: usize = 51;
const OPENAI_API_HOST: &str = "api.platform.deepseek.com";
...
fn dummy_value(real_value: &str) -> String {
    shaped_dummy_value(
        real_value,
        deepseek_api_key_prefix(real_value),
        DEEPSEEK_API_KEY_MIN_LEN,
    )
}
...
fn deepseek_api_key_prefix(value: &str) -> &str {
