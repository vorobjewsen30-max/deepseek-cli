...
use deepseek_app_server_protocol::AttestationGenerateResponse;
    ...
    let initialized = timeout(
        ...
        mcp.initialize_with_capabilities(
            ClientInfo {
                ...
                title: Some("DeepSeek Desktop".to_string()),
...
fn create_chatgpt_websocket_config(deepseek_home: &Path, server_uri: &str) -> std::io::Result<()> {
    std::fs::write(
