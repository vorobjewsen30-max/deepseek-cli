...
use deepseek_app_server_protocol::ExperimentalFeature;
...
use deepseek_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let deepseek_home = TempDir::new()?;
    let project_cwd = deepseek_home.path().join("project");
