...
use deepseek_config::types::OtelHttpProtocol;
...
fn set_metrics_exporter(config: &mut deepseek_core::config::Config) {
...
pub(crate) async fn mount_analytics_capture(server: &MockServer, deepseek_home: &Path) -> Result<()> {
