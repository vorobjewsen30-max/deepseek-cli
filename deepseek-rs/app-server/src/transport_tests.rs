    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: deepseek_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        deepseek_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                deepseek_app_server_protocol::AdditionalFileSystemPermissions {
