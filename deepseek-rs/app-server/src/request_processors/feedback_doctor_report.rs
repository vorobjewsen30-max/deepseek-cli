...
//! the configured DeepSeek executable as a subprocess, accepts only valid JSON from
...
use deepseek_feedback::FeedbackAttachment;
...
///
/// Failure to spawn DeepSeek, finish before the timeout, or parse JSON means the
