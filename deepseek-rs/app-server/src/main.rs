...
use deepseek_app_server::AppServerWebsocketAuthArgs;
    ...
    arg0_dispatch_or_else(move |arg0_paths: Arg0DispatchPaths| async move {
        ...
        runtime_options.remote_control_startup_mode =
            match (remote_control, remote_control_disabled) {
                (true, _) => deepseek_app_server::RemoteControlStartupMode::EnabledEphemeral,
                (false, true) => deepseek_app_server::RemoteControlStartupMode::DisabledEphemeral,
                (false, false) => deepseek_app_server::RemoteControlStartupMode::ResolvePersisted,
            };
