...
use deepseek_app_server_protocol::Config as ApiConfig;
...
use deepseek_core::config::deserialize_config_toml_with_base;
use deepseek_core::config::edit::ConfigEdit;
use deepseek_core::config::edit::ConfigEditsBuilder;
use deepseek_core::config::validate_feature_requirements_for_config_toml;
use deepseek_core::path_utils;
use deepseek_core::path_utils::SymlinkWritePaths;
use deepseek_core::path_utils::resolve_symlink_write_paths;
use deepseek_core::path_utils::write_atomically;
...
impl ConfigManager {
    ...
    async fn apply_edits(
        ...
        let user_config_toml =
            deserialize_config_toml_with_base(user_config.clone(), self.deepseek_home()).map_err(
                |err| {
                    ConfigManagerError::write(
                        ConfigWriteErrorCode::ConfigValidationError,
                        format!("Invalid configuration: {err}"),
