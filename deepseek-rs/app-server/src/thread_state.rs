...
use deepseek_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: deepseek_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<deepseek_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<DeepSeekThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<DeepSeekThread>) -> bool {
