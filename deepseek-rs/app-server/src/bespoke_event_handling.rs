...
use deepseek_app_server_protocol::AccountRateLimitsUpdatedNotification;
use deepseek_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use deepseek_app_server_protocol::DeepSeekErrorInfo as V2DeepSeekErrorInfo;
use deepseek_app_server_protocol::CommandAction as V2ParsedCommand;
use deepseek_app_server_protocol::CommandExecutionApprovalDecision;
use deepseek_app_server_protocol::CommandExecutionRequestApprovalParams;
use deepseek_app_server_protocol::CommandExecutionRequestApprovalResponse;
use deepseek_app_server_protocol::CommandExecutionSource;
use deepseek_app_server_protocol::CommandExecutionStatus;
use deepseek_app_server_protocol::DeprecationNoticeNotification;
use deepseek_app_server_protocol::DynamicToolCallParams;
use deepseek_app_server_protocol::DynamicToolCallStatus;
use deepseek_app_server_protocol::ErrorNotification;
use deepseek_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use deepseek_app_server_protocol::FileChangeApprovalDecision;
use deepseek_app_server_protocol::FileChangeRequestApprovalParams;
use deepseek_app_server_protocol::FileChangeRequestApprovalResponse;
use deepseek_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use deepseek_app_server_protocol::GuardianWarningNotification;
use deepseek_app_server_protocol::HookCompletedNotification;
use deepseek_app_server_protocol::HookStartedNotification;
use deepseek_app_server_protocol::ItemCompletedNotification;
use deepseek_app_server_protocol::ItemStartedNotification;
use deepseek_app_server_protocol::McpServerElicitationAction;
use deepseek_app_server_protocol::McpServerElicitationRequestParams;
use deepseek_app_server_protocol::McpServerElicitationRequestResponse;
use deepseek_app_server_protocol::McpServerStartupState;
use deepseek_app_server_protocol::McpServerStatusUpdatedNotification;
use deepseek_app_server_protocol::ModelReroutedNotification;
use deepseek_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use deepseek_app_server_protocol::ModelVerificationNotification;
use deepseek_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use deepseek_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use deepseek_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use deepseek_app_server_protocol::PermissionsRequestApprovalParams;
use deepseek_app_server_protocol::PermissionsRequestApprovalResponse;
use deepseek_app_server_protocol::RawResponseItemCompletedNotification;
use deepseek_app_server_protocol::RequestId;
use deepseek_app_server_protocol::ServerNotification;
use deepseek_app_server_protocol::ServerRequestPayload;
use deepseek_app_server_protocol::ThreadGoalUpdatedNotification;
use deepseek_app_server_protocol::ThreadItem;
use deepseek_app_server_protocol::ThreadRealtimeClosedNotification;
use deepseek_app_server_protocol::ThreadRealtimeErrorNotification;
use deepseek_app_server_protocol::ThreadRealtimeItemAddedNotification;
use deepseek_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use deepseek_app_server_protocol::ThreadRealtimeSdpNotification;
use deepseek_app_server_protocol::ThreadRealtimeStartedNotification;
use deepseek_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use deepseek_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use deepseek_app_server_protocol::ThreadRollbackResponse;
use deepseek_app_server_protocol::ThreadSettingsUpdatedNotification;
use deepseek_app_server_protocol::ThreadStatus;
use deepseek_app_server_protocol::ThreadTokenUsage;
use deepseek_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use deepseek_app_server_protocol::ToolRequestUserInputOption;
use deepseek_app_server_protocol::ToolRequestUserInputParams;
use deepseek_app_server_protocol::ToolRequestUserInputQuestion;
use deepseek_app_server_protocol::ToolRequestUserInputResponse;
use deepseek_app_server_protocol::Turn;
use deepseek_app_server_protocol::TurnCompletedNotification;
use deepseek_app_server_protocol::TurnDiffUpdatedNotification;
...
use deepseek_app_server_protocol::TurnModerationMetadataNotification;
use deepseek_app_server_protocol::TurnPlanStep;
use deepseek_app_server_protocol::TurnPlanUpdatedNotification;
use deepseek_app_server_protocol::TurnStartedNotification;
use deepseek_app_server_protocol::TurnStatus;
use deepseek_app_server_protocol::WarningNotification;
use deepseek_app_server_protocol::build_item_from_guardian_event;
use deepseek_app_server_protocol::guardian_auto_approval_review_notification;
use deepseek_app_server_protocol::item_event_to_server_notification;
use deepseek_core::DeepSeekThread;
use deepseek_core::ThreadManager;
use deepseek_core::review_format::format_review_findings_block;
use deepseek_core::review_prompts;
use deepseek_protocol::ThreadId;
use deepseek_protocol::items::parse_hook_prompt_message;
use deepseek_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use deepseek_protocol::plan_tool::UpdatePlanArgs;
use deepseek_protocol::protocol::DeepSeekErrorInfo as CoreDeepSeekErrorInfo;
use deepseek_protocol::protocol::Event;
use deepseek_protocol::protocol::EventMsg;
use deepseek_protocol::protocol::ExecApprovalRequestEvent;
use deepseek_protocol::protocol::Op;
use deepseek_protocol::protocol::RealtimeEvent;
use deepseek_protocol::protocol::ReviewDecision;
use deepseek_protocol::protocol::ReviewOutputEvent;
...
use deepseek_protocol::protocol::TurnDiffEvent;
use deepseek_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use deepseek_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use deepseek_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use deepseek_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use deepseek_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use deepseek_sandboxing::policy_transforms::intersect_permission_profiles;
use deepseek_shell_command::parse_command::shlex_join;
use deepseek_utils_absolute_path::AbsolutePathBuf;
use deepseek_utils_path_uri::LegacyAppPathString;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<DeepSeekThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                deepseek_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                deepseek_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                deepseek_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                deepseek_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == deepseek_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                deepseek_protocol::protocol::GuardianAssessmentStatus::Denied
                | deepseek_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                deepseek_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                deepseek_protocol::protocol::GuardianAssessmentStatus::InProgress
                | deepseek_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: deepseek_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            if matches!(
                codex_error_info,
                Some(CoreDeepSeekErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                codex_error_info: ev.codex_error_info.map(V2DeepSeekErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(
                ...
                deepseek_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: deepseek_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let deepseek_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(deepseek_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: deepseek_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: deepseek_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<DeepSeekThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: deepseek_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            deepseek_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anyhow::bail;
    use chrono::Utc;
    use deepseek_app_server_protocol::AutoReviewDecisionSource;
    use deepseek_app_server_protocol::GuardianApprovalReviewStatus;
    use deepseek_app_server_protocol::JSONRPCErrorError;
    use deepseek_app_server_protocol::TurnPlanStepStatus;
    use deepseek_login::DeepSeekAuth;
    use deepseek_protocol::AgentPath;
    use deepseek_protocol::items::HookPromptFragment;
    use deepseek_protocol::items::build_hook_prompt_message;
    use deepseek_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use deepseek_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use deepseek_protocol::plan_tool::PlanItemArg;
    use deepseek_protocol::plan_tool::StepStatus;
    use deepseek_protocol::protocol::AgentMessageEvent;
    use deepseek_protocol::protocol::AskForApproval;
    use deepseek_protocol::protocol::CreditsSnapshot;
    use deepseek_protocol::protocol::EventMsg;
    use deepseek_protocol::protocol::GuardianAssessmentEvent;
    use deepseek_protocol::protocol::GuardianAssessmentStatus;
    ...
    use deepseek_thread_store::StoredThreadHistory;
    use deepseek_utils_absolute_path::AbsolutePathBuf;
    use deepseek_utils_absolute_path::test_support::PathBufExt;
    use deepseek_utils_absolute_path::test_support::test_path_buf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: deepseek_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(deepseek_protocol::protocol::GuardianRiskLevel::Low),
                Some(deepseek_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(deepseek_protocol::protocol::GuardianRiskLevel::High),
                Some(deepseek_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(deepseek_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = deepseek_protocol::protocol::GuardianAssessmentAction::Command {
            source: deepseek_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: deepseek_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: deepseek_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(deepseek_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(deepseek_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    deepseek_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(deepseek_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(deepseek_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = deepseek_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.platform.deepseek.com:443".to_string(),
            host: "api.platform.deepseek.com".to_string(),
            protocol: deepseek_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: deepseek_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            deepseek_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&deepseek_home).await;
        let thread_manager = Arc::new(
            deepseek_core::test_support::thread_manager_with_models_provider_and_home(
                DeepSeekAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.deepseek_home.to_path_buf(),
                Arc::new(deepseek_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let deepseek_core::NewThread {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codex_error_info: Some(V2DeepSeekErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(deepseek_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(deepseek_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(deepseek_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    ...
                    kind: deepseek_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codex_error_info: Some(V2DeepSeekErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codex_error_info: Some(V2DeepSeekErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            deepseek_app_server_protocol::HookPromptFragment {
