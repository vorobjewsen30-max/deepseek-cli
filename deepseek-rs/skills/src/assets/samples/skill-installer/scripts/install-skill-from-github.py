#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $DEEPSEEK_HOME/skills."""
...
def _deepseek_home() -> str:
    return os.environ.get("DEEPSEEK_HOME", os.path.expanduser("~/.codex"))
...
def _default_dest() -> str:
    return os.path.join(_deepseek_home(), "skills")
