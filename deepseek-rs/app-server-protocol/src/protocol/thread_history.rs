...
use deepseek_protocol::models::MessagePhase;
use deepseek_protocol::protocol::AgentReasoningEvent;
use deepseek_protocol::protocol::AgentReasoningRawContentEvent;
...
use deepseek_protocol::protocol::ContextCompactedEvent;
use deepseek_protocol::protocol::DynamicToolCallResponseEvent;
use deepseek_protocol::protocol::ErrorEvent;
use deepseek_protocol::protocol::EventMsg;
use deepseek_protocol::protocol::ExecCommandBeginEvent;
use deepseek_protocol::protocol::ExecCommandEndEvent;
use deepseek_protocol::protocol::GuardianAssessmentEvent;
use deepseek_protocol::protocol::GuardianAssessmentStatus;
use deepseek_protocol::protocol::ImageGenerationBeginEvent;
use deepseek_protocol::protocol::ImageGenerationEndEvent;
use deepseek_protocol::protocol::ItemCompletedEvent;
use deepseek_protocol::protocol::ItemStartedEvent;
use deepseek_protocol::protocol::McpToolCallBeginEvent;
use deepseek_protocol::protocol::McpToolCallEndEvent;
use deepseek_protocol::protocol::PatchApplyBeginEvent;
use deepseek_protocol::protocol::PatchApplyEndEvent;
...
use deepseek_protocol::protocol::ViewImageToolCallEvent;
use deepseek_protocol::protocol::WebSearchBeginEvent;
use deepseek_protocol::protocol::WebSearchEndEvent;
...
#[cfg(test)]
use deepseek_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use deepseek_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    fn handle_response_item(&mut self, item: &deepseek_protocol::models::ResponseItem) {
    ...
    fn handle_materialized_item_lifecycle(
        &mut self,
        turn_id: &str,
        item: &deepseek_protocol::items::TurnItem,
    ) {
        let should_upsert = match item {
            deepseek_protocol::items::TurnItem::Plan(plan) => !plan.text.is_empty(),
            deepseek_protocol::items::TurnItem::Sleep(_)
            | deepseek_protocol::items::TurnItem::CommandExecution(_)
            | deepseek_protocol::items::TurnItem::DynamicToolCall(_)
            | deepseek_protocol::items::TurnItem::CollabAgentToolCall(_)
            | deepseek_protocol::items::TurnItem::SubAgentActivity(_) => true,
            deepseek_protocol::items::TurnItem::UserMessage(_)
            | deepseek_protocol::items::TurnItem::HookPrompt(_)
            | deepseek_protocol::items::TurnItem::AgentMessage(_)
            | deepseek_protocol::items::TurnItem::Reasoning(_)
            | deepseek_protocol::items::TurnItem::WebSearch(_)
            | deepseek_protocol::items::TurnItem::ImageView(_)
            | deepseek_protocol::items::TurnItem::ImageGeneration(_)
            | deepseek_protocol::items::TurnItem::FileChange(_)
            | deepseek_protocol::items::TurnItem::McpToolCall(_)
            | deepseek_protocol::items::TurnItem::ContextCompaction(_) => false,
        };
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &deepseek_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_sub_agent_activity(
        &mut self,
        payload: &deepseek_protocol::protocol::SubAgentActivityEvent,
    ) {
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_close_end(&mut self, payload: &deepseek_protocol::protocol::CollabCloseEndEvent) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
        };
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &deepseek_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(&mut self, payload: &deepseek_protocol::protocol::ReviewRequest) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &deepseek_protocol::protocol::ExitedReviewModeEvent,
    ) {
        let review = payload
            .review_output
            .as_ref()
...
fn convert_dynamic_tool_content_items(
    items: &[deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText { text } => {
                DynamicToolCallOutputContentItem::InputText { text }
            }
            deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
...
mod tests {
    ...
    use deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use deepseek_protocol::items::CommandExecutionItem as CoreCommandExecutionItem;
    use deepseek_protocol::items::CommandExecutionStatus as CoreCommandExecutionStatus;
    use deepseek_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use deepseek_protocol::items::SleepItem as CoreSleepItem;
    use deepseek_protocol::items::TurnItem as CoreTurnItem;
    use deepseek_protocol::items::UserMessageItem as CoreUserMessageItem;
    use deepseek_protocol::items::build_hook_prompt_message;
    use deepseek_protocol::mcp::CallToolResult;
    use deepseek_protocol::models::ImageDetail;
    use deepseek_protocol::models::MessagePhase as CoreMessagePhase;
    use deepseek_protocol::models::WebSearchAction as CoreWebSearchAction;
    use deepseek_protocol::parse_command::ParsedCommand;
    ...
    use deepseek_protocol::protocol::DynamicToolCallResponseEvent;
    use deepseek_protocol::protocol::ExecCommandEndEvent;
    use deepseek_protocol::protocol::ExecCommandSource;
    use deepseek_protocol::protocol::ItemStartedEvent;
    use deepseek_protocol::protocol::McpInvocation;
    use deepseek_protocol::protocol::McpToolCallEndEvent;
    use deepseek_protocol::protocol::PatchApplyBeginEvent;
    use deepseek_protocol::protocol::ThreadRolledBackEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![deepseek_protocol::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                deepseek_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    deepseek_protocol::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(deepseek_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(deepseek_protocol::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: deepseek_protocol::deepseek_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(deepseek_protocol::deepseek_models::ReasoningEffort::Medium),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                deepseek_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                deepseek_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn rollback_failed_error_does_not_mark_turn_failed() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                codex_error_info: Some(DeepSeekErrorInfo::ThreadRollbackFailed),
            }),
        ];
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                codex_error_info: Some(DeepSeekErrorInfo::ResponseStreamDisconnected {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                ...
                codex_error_info: Some(
                    crate::protocol::v2::DeepSeekErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(deepseek_protocol::models::ResponseItem::Message {
                id: Some("msg-1".into()),
                role: "user".into(),
                content: vec![deepseek_protocol::models::ContentItem::InputText {
