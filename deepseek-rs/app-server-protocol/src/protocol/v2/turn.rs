...
use deepseek_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use deepseek_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use deepseek_protocol::user_input::ByteRange as CoreByteRange;
use deepseek_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich DeepSeek's ResponsesAPI turn metadata.
    ///
