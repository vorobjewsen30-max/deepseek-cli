...
use deepseek_protocol::deepseek_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use deepseek_protocol::deepseek_models::ReasoningEffort;
use deepseek_protocol::deepseek_models::default_input_modalities;
use deepseek_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use deepseek_protocol::protocol::ModelVerification as CoreModelVerification;
