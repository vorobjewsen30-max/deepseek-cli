...
use deepseek_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use deepseek_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use deepseek_protocol::protocol::ThreadSource as CoreThreadSource;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. DeepSeek-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Model provider used for this thread (for example, 'deepseek').
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. DeepSeek-generated turn IDs are UUIDv7.
    pub id: String,
