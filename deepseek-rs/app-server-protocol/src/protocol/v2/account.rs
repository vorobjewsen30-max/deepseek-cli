...
use deepseek_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use deepseek_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use deepseek_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use deepseek_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use deepseek_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that DeepSeek-managed DeepSeek auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, DeepSeek attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// DeepSeek attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that DeepSeek was previously using.
    ///
