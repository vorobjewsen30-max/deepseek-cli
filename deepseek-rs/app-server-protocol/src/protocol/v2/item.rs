...
use deepseek_experimental_api_macros::ExperimentalApi;
use deepseek_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use deepseek_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use deepseek_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use deepseek_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use deepseek_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use deepseek_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use deepseek_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use deepseek_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use deepseek_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<deepseek_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: deepseek_protocol::models::WebSearchAction) -> Self {
        match value {
            deepseek_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            deepseek_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            deepseek_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            deepseek_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<deepseek_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: deepseek_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for deepseek_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
