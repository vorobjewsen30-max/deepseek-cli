...
pub use deepseek_protocol::capabilities::CapabilityRootLocation;
pub use deepseek_protocol::capabilities::SelectedCapabilityRoot;
...
use deepseek_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use deepseek_protocol::protocol::TokenUsage as CoreTokenUsage;
use deepseek_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "deepseek_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. DeepSeek Cloud).
...
impl From<deepseek_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: deepseek_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> deepseek_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => deepseek_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => deepseek_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `deepseek_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
