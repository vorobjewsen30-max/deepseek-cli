...
use deepseek_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use deepseek_protocol::protocol::SkillInterface as CoreSkillInterface;
use deepseek_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use deepseek_protocol::protocol::SkillScope as CoreSkillScope;
use deepseek_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// DeepSeek app-server exposes `"AVAILABLE"` in its API; the alias keeps
