...
use deepseek_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use deepseek_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use deepseek_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use deepseek_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use deepseek_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use deepseek_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use deepseek_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> deepseek_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<deepseek_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: deepseek_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            deepseek_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            deepseek_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            deepseek_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
