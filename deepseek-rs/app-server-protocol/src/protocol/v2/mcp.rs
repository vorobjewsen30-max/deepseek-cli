...
use deepseek_protocol::items::McpToolCallError as CoreMcpToolCallError;
use deepseek_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use deepseek_protocol::mcp::McpServerInfo;
use deepseek_protocol::mcp::Resource as McpResource;
pub use deepseek_protocol::mcp::ResourceContent as McpResourceContent;
use deepseek_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use deepseek_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from deepseek_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from deepseek_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> deepseek_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => deepseek_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => deepseek_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => deepseek_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active DeepSeek turn when this elicitation was observed, if app-server could correlate one.
    ///
...
pub enum McpServerElicitationRequest {
    ...
    #[serde(rename = "deepseek/form", rename_all = "camelCase")]
    #[ts(rename = "deepseek/form", rename_all = "camelCase")]
    OpenAiForm {
        #[serde(rename = "_meta")]
        #[ts(rename = "_meta")]
        meta: Option<JsonValue>,
