...
pub use deepseek_file_system::WalkOptions;
pub use deepseek_file_system::WalkOutcome;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: deepseek_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `deepseek-linux-sandbox` are command
