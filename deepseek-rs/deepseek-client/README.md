...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any DeepSeek/DeepSeek awareness.
...
- Consumed by higher-level crates like `deepseek-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
