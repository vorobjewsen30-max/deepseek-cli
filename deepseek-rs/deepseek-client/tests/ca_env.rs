...
//! detailed explanation of what "hermetic" means here lives in `deepseek_client::custom_ca`; these
...
const CODEX_CA_CERT_ENV: &str = "DEEPSEEK_CA_CERTIFICATE";
...
fn rejects_empty_pem_file_with_hint() {
    ...
    assert!(stderr.contains("DEEPSEEK_CA_CERTIFICATE"));
