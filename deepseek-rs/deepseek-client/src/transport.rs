use crate::default_client::DeepSeekHttpClient;
use crate::default_client::DeepSeekRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: DeepSeekHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<DeepSeekRequestBuilder, TransportError> {
