use deepseek_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use deepseek_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use deepseek_protocol::config_types::CollaborationModeMask;
use deepseek_protocol::config_types::ModeKind;
use deepseek_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
