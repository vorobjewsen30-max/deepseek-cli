...
use deepseek_otel::AuthEnvTelemetryMetadata;

use crate::DEEPSEEK_API_KEY_ENV_VAR;
use crate::DEEPSEEK_API_KEY_ENV_VAR;
use crate::REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR;

#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct AuthEnvTelemetry {
    pub deepseek_api_key_env_present: bool,
    pub deepseek_api_key_env_present: bool,
    pub deepseek_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            deepseek_api_key_env_present: self.deepseek_api_key_env_present,
            deepseek_api_key_env_present: self.deepseek_api_key_env_present,
            deepseek_api_key_env_enabled: self.deepseek_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    deepseek_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        deepseek_api_key_env_present: env_var_present(DEEPSEEK_API_KEY_ENV_VAR),
        deepseek_api_key_env_present: env_var_present(DEEPSEEK_API_KEY_ENV_VAR),
        deepseek_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*deepseek_api_key_env_enabled*/ false);
