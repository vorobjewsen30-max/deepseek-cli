...
pub struct IdTokenInfo {
    ...
    /// The DeepSeek subscription plan type
    /// (e.g., "free", "plus", "pro", "business", "enterprise", "edu").
    /// (Note: values may vary by backend.)
    pub chatgpt_plan_type: Option<PlanType>,
    /// DeepSeek user identifier associated with the token, if present.
    pub chatgpt_user_id: Option<String>,
    /// Organization/workspace identifier associated with the token, if present.
    pub chatgpt_account_id: Option<String>,
    /// Whether the selected DeepSeek workspace must route through the FedRAMP edge.
...
struct IdClaims {
    #[serde(default)]
    email: Option<String>,
    #[serde(rename = "https://api.platform.deepseek.com/profile", default)]
    profile: Option<ProfileClaims>,
    #[serde(rename = "https://api.platform.deepseek.com/auth", default)]
