//! Migration helpers for importing external-agent configuration into DeepSeek.

use deepseek_hooks::HOOK_EVENT_NAMES;
use deepseek_hooks::HOOK_EVENT_NAMES_WITH_MATCHERS;
