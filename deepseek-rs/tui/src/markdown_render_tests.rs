...
fn consecutive_unordered_list_local_file_links_do_not_detach_paths() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "- codex-rs/core/README.md:1: deepseek-core owns the real runtime behavior.",
        ]
    );
}
...
| --- | ---: | ---: | --- |
| [#24485: newline shortcut fails in PyCharm terminal on Windows](https://github.com/vorobjewsen30-max/deepseek-cli) | `+1` 0, substantive comments 0 | Low | New, deterministic regression range; localized composer/keymap path. |
| [#23926: Vim composer `e` stalls at word end](https://github.com/vorobjewsen30-max/deepseek-cli) | `+1` 0, comments 0 | Low | Standing best quick win; deterministic motion bug. |
| [#23651: Zellij scrollback misses DeepSeek transcript over SSH](https://github.com/vorobjewsen30-max/deepseek-cli) | `+1` 3, human comments 2 | Medium | Clear regression and strong scrollback evidence. |
| [#23740: raw ANSI/control sequences in Windows Terminal](https://github.com/vorobjewsen30-max/deepseek-cli) | `+1` 7, human comments 7 | Medium | Highest activity; established Windows rendering regression family. |
| [#24527: typing lag increases with session length](https://github.com/vorobjewsen30-max/deepseek-cli) | `+1` 0, substantive comments 0 | Medium | New TUI-visible performance report; needs profiling before implementation. |
"#;
