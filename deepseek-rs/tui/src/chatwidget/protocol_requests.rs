...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: deepseek_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, deepseek_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                deepseek_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                deepseek_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                deepseek_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                deepseek_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                deepseek_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                deepseek_app_server_protocol::GuardianRiskLevel::Low => {
                    deepseek_protocol::approvals::GuardianRiskLevel::Low
                }
                deepseek_app_server_protocol::GuardianRiskLevel::Medium => {
                    deepseek_protocol::approvals::GuardianRiskLevel::Medium
                }
                deepseek_app_server_protocol::GuardianRiskLevel::High => {
                    deepseek_protocol::approvals::GuardianRiskLevel::High
                }
                deepseek_app_server_protocol::GuardianRiskLevel::Critical => {
                    deepseek_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    deepseek_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        deepseek_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    deepseek_app_server_protocol::GuardianUserAuthorization::Low => {
                        deepseek_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    deepseek_app_server_protocol::GuardianUserAuthorization::Medium => {
                        deepseek_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    deepseek_app_server_protocol::GuardianUserAuthorization::High => {
                        deepseek_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                deepseek_app_server_protocol::AutoReviewDecisionSource::Agent => {
