...
impl ChatWidget {
    ...
    /// Clears the terminal title DeepSeek most recently wrote, if any.
    ///
    ...
    pub(super) fn status_line_value_for_item(&mut self, item: StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::DeepSeekVersion => Some(CODEX_CLI_VERSION.to_string()),
    ...
    pub(super) fn status_surface_preview_value_for_item(
        ...
        let status_line_item = match item {
            ...
            StatusSurfacePreviewItem::DeepSeekVersion => StatusLineItem::DeepSeekVersion,
    ...
    pub(super) fn terminal_title_value_for_item(
        ...
        match item {
            ...
            TerminalTitleItem::WeeklyLimit => self
                ...
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
            TerminalTitleItem::DeepSeekVersion => self
                .status_line_value_for_item(StatusLineItem::DeepSeekVersion)
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
