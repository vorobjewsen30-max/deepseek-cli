...
impl ChatWidget {
    ...
    fn plugin_install_auth_popup_params(&self) -> Option<SelectionViewParams> {
        ...
        let status_label = if is_installed {
            ...
            "Install the required Apps in DeepSeek to continue:"
        };
        ...
        if let Some(install_url) = app.install_url.clone() {
            ...
            items.push(SelectionItem {
                ...
                description: Some("Open the DeepSeek app management page".to_string()),
            ...
            items.push(SelectionItem {
                name: "DeepSeek apps link unavailable".to_string(),
