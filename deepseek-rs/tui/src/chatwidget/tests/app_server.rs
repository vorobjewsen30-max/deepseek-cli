...
fn thread_settings_for_test(
    model: &str,
    thread_id: ThreadId,
) -> deepseek_app_server_protocol::ThreadSettingsUpdatedNotification {
    deepseek_app_server_protocol::ThreadSettingsUpdatedNotification {
        thread_id: thread_id.to_string(),
        thread_settings: deepseek_app_server_protocol::ThreadSettings {
...
async fn safety_buffering_offers_one_retry_with_app_wording() {
    ...
    assert_eq!(opened_url, "https://help.platform.deepseek.com/en/articles/20001326");
...
async fn invalid_url_elicitation_is_declined() {
    ...
    chat.handle_elicitation_request_now(
        deepseek_app_server_protocol::RequestId::Integer(9),
        deepseek_app_server_protocol::McpServerElicitationRequestParams {
            thread_id: request_thread_id.to_string(),
            turn_id: Some("turn-auth".to_string()),
            server_name: "payments".to_string(),
            request: deepseek_app_server_protocol::McpServerElicitationRequest::Url {
                meta: None,
    ...
    assert_matches!(
        ...
        Ok(AppEvent::SubmitThreadOp {
            ...
            op: Op::ResolveElicitation {
                server_name,
                request_id: deepseek_app_server_protocol::RequestId::Integer(9),
...
async fn thread_settings_updated_updates_visible_state_without_transcript() {
    ...
    assert_eq!(
        chat.config_ref()
            ...
            .id,
        deepseek_protocol::models::BUILT_IN_PERMISSION_PROFILE_READ_ONLY
    );
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                codex_error_info: Some(DeepSeekErrorInfo::CyberPolicy),
                additional_details: None,
            },
            will_retry: false,
            thread_id: "thread-1".to_string(),
