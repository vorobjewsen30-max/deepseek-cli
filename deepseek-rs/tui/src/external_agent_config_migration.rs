...
mod tests {
    ...
    fn sample_plugin_details() -> deepseek_app_server_protocol::MigrationDetails {
        deepseek_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ...
            ExternalAgentConfigMigrationItem {
                ...
                cwd: None,
                details: Some(deepseek_app_server_protocol::MigrationDetails {
