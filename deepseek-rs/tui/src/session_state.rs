...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: deepseek_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<deepseek_protocol::deepseek_models::ReasoningEffort>,
