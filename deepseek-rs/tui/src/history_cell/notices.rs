...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/vorobjewsen30-max/deepseek-cli).underlined(),
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/vorobjewsen30-max/deepseek-cli for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/vorobjewsen30-max/deepseek-cli),
        ]
    }
...
const SAFETY_ACCESS_BLOCK_LEARN_MORE_URL: &str = "https://help.platform.deepseek.com/en/articles/20001326";
...
pub(crate) fn new_safety_access_block_event() -> SafetyAccessBlockCell {
    SafetyAccessBlockCell {
        ...
        trusted_access_url: "https://www.platform.deepseek.com/form/trusted-access-for-biology-research/",
    }
}
...
pub(crate) fn new_cyber_policy_error_event() -> SafetyAccessBlockCell {
    SafetyAccessBlockCell {
        ...
        trusted_access_url: "https://platform.deepseek.com
    }
}
