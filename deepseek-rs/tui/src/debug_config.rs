...
use deepseek_config::NetworkUnixSocketPermissionToml;
use deepseek_config::RequirementSource;
use deepseek_config::ResidencyRequirement;
use deepseek_config::SandboxModeRequirement;
use deepseek_config::WebSearchModeRequirement;
use deepseek_config::format_config_layer_source;
...
mod tests {
    ...
    use deepseek_config::ConstraintError;
    use deepseek_config::FeatureRequirementsToml;
    use deepseek_config::FilesystemConstraints;
    use deepseek_config::HookEventsToml;
    use deepseek_config::HookHandlerConfig;
    use deepseek_config::ManagedHooksRequirementsToml;
    use deepseek_config::MatcherGroup;
    ...
    use deepseek_config::NetworkUnixSocketPermissionToml;
    use deepseek_config::NetworkUnixSocketPermissionsToml;
    use deepseek_config::RequirementSource;
    use deepseek_config::ResidencyRequirement;
    use deepseek_config::SandboxModeRequirement;
    ...
    fn debug_config_output_lists_requirement_sources() {
        let requirements_file = if cfg!(windows) {
            absolute_path("C:\\ProgramData\\DeepSeek\\DeepSeek\\requirements.toml")
        } else {
                ...
                BTreeMap::from([(
                    ...
                    McpServerRequirement::Identity {
                        identity: McpServerIdentity::Command {
                            command: "deepseek-mcp".to_string(),
                        },
                    },
                )]),
