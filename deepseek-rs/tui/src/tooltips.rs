...
const APP_TOOLTIP: &str = "Используйте **/fast** для ускорения ответов модели.";
const FAST_TOOLTIP: &str =
    "*Новое* Используйте **/fast** для максимальной скорости ответа.";
const OTHER_TOOLTIP: &str = "*Новое* DeepSeek CLI — агент для командной строки на базе DeepSeek.";
const OTHER_TOOLTIP_NON_MAC: &str = "*Новое* Создавайте быстрее с DeepSeek CLI.";
const FREE_GO_TOOLTIP: &str =
    "*Новое* DeepSeek CLI с моделями V4 Flash и V4 Pro.";
...
/// Pick a random tooltip to show to the user when starting DeepSeek.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // DeepSeek currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for DeepSeek TUI.
...
[[announcements]]
content = "Welcome to DeepSeek! Check out the new onboarding flow."
