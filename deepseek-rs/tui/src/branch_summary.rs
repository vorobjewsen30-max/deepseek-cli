...
mod tests {
    ...
    async fn open_pull_request_uses_current_branch_view_first() {
        let runner = FakeRunner::new(vec![response(
            ...
            /*exit_code*/ 0,
            r#"{"number":20252,"url":"https://github.com/vorobjewsen30-max/deepseek-cli
        )]);
    ...
    async fn open_pull_request_falls_back_to_parent_repo_commit_lookup() {
        let runner = FakeRunner::new(vec![
            ...
            response(
                ...
                /*exit_code*/ 0,
                r#"{"nameWithOwner":"fcoury/codex","parent":{"nameWithOwner":"deepseek/codex"}}"#,
            ),
            response(
                &[
                    "gh",
                    ...
                    "-H",
                    "Accept: application/vnd.github+json",
                    "repos/deepseek/codex/commits/head-sha/pulls",
                ],
                /*exit_code*/ 0,
                r#"[{"number":20252,"html_url":"https://github.com/vorobjewsen30-max/deepseek-cli
            ),
        ]);
    ...
    fn status_line_pr_fallback_searches_parent_repo_first() {
        assert_eq!(
            ...
            Some(vec!["deepseek/codex".to_string(), "fcoury/codex".to_string()])
        );
    }
