...
/// Restore the terminal after DeepSeek is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = deepseek_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr (optionally keeping raw mode enabled), then re-applies DeepSeek TUI
