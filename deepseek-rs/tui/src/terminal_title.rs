...
//! "leave the old title alone" or "clear the title DeepSeek last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title DeepSeek manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before DeepSeek started managing the title.
