...
use deepseek_app_server_protocol::FileSystemAccessMode;
use deepseek_app_server_protocol::FileSystemPath;
use deepseek_app_server_protocol::FileSystemSandboxEntry;
use deepseek_app_server_protocol::FileSystemSpecialPath;
use deepseek_app_server_protocol::McpServerElicitationAction;
use deepseek_app_server_protocol::NetworkApprovalContext;
use deepseek_app_server_protocol::NetworkApprovalProtocol;
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: "No, and tell DeepSeek what to do differently".to_string(),
...
mod tests {
    ...
    use deepseek_app_server_protocol::ExecPolicyAmendment;
    use deepseek_app_server_protocol::NetworkApprovalProtocol;
    use deepseek_app_server_protocol::NetworkPolicyAmendment;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell DeepSeek what to do differently".to_string(),
            ]
        );
    }
