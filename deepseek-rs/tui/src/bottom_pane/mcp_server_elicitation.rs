...
use deepseek_app_server_protocol::McpElicitationEnumSchema;
use deepseek_app_server_protocol::McpElicitationPrimitiveSchema;
use deepseek_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use deepseek_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use deepseek_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use deepseek_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use deepseek_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use deepseek_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use deepseek_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use deepseek_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use deepseek_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use deepseek_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
    ...
    fn plugin_tool_suggestion_meta_without_install_url_is_parsed_into_request_payload() {
        let request = from_form_request(
            ...
            form_request(
                ...
                Some(serde_json::json!({
                    ...
                    "tool_id": "slack@deepseek-curated",
                    "tool_name": "Slack",
                })),
            ),
        )
        ...
        assert_eq!(
            ...
            Some(&ToolSuggestionRequest {
                ...
                tool_id: "slack@deepseek-curated".to_string(),
