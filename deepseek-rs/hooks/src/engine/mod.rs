...
use deepseek_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    pub event_name: deepseek_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            deepseek_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            deepseek_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            deepseek_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            deepseek_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            deepseek_protocol::protocol::HookEventName::PostCompact => "post-compact",
            deepseek_protocol::protocol::HookEventName::SessionStart => "session-start",
            deepseek_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            deepseek_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            deepseek_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            deepseek_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<deepseek_protocol::items::HookPromptFragment>,
    ) -> Vec<deepseek_protocol::items::HookPromptFragment> {
        self.output_spiller
