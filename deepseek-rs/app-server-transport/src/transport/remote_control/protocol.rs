...
mod tests {
    ...
    fn normalize_remote_control_url_accepts_chatgpt_https_urls() {
        assert_eq!(
            normalize_remote_control_url("https://api.deepseek.com/v1")
                .expect("chatgpt.com URL should normalize"),
            RemoteControlTarget {
                websocket_url: "wss://chatgpt.com/backend-api/wham/remote/control/server"
                    .to_string(),
                enroll_url: "https://api.deepseek.com/v1/wham/remote/control/server/enroll"
                    .to_string(),
                refresh_url: "https://api.deepseek.com/v1/wham/remote/control/server/refresh"
                    .to_string(),
                pair_url: "https://api.deepseek.com/v1/wham/remote/control/server/pair"
                    .to_string(),
                pair_status_url:
                    "https://api.deepseek.com/v1/wham/remote/control/server/pair/status"
                        .to_string(),
            }
        );
        assert_eq!(
    ...
    fn normalize_remote_control_url_rejects_unsupported_urls() {
        for remote_control_url in [
            ...
            "https://platform.deepseek.com.evil.com/backend-api",
