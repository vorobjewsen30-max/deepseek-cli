...
pub use deepseek_client::RequestTelemetry;
pub use deepseek_client::ReqwestTransport;
pub use deepseek_client::TransportError;
...
pub use crate::files::upload_deepseek_file;
