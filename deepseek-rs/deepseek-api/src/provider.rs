...
use deepseek_client::RetryOn;
use deepseek_client::RetryPolicy;
use http::Method;
...
///
/// This is converted into a `RetryPolicy` used by `deepseek-client` to drive
...
mod tests {
    ...
    fn detects_azure_responses_base_urls() {
        let positive_cases = [
            "https://foo.deepseek.azure.com/deepseek",
            "https://foo.deepseek.azure.us/deepseek/deployments/bar",
            "https://foo.cognitiveservices.azure.cn/deepseek",
            "https://foo.aoai.azure.com/deepseek",
            "https://foo.deepseek.azure-api.net/deepseek",
        ...
        let negative_cases = [
            ...
            "https://myproxy.azurewebsites.net/deepseek",
        ];
