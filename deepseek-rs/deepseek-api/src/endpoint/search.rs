...
use deepseek_client::RequestTelemetry;
use http::HeaderMap;
use http::Method;
                ...
                &SearchRequest {
                    ...
                    commands: Some(SearchCommands {
                        search_query: Some(vec![SearchQuery {
                            q: "DeepSeek news".to_string(),
                            recency: Some(7),
                            domains: Some(vec!["platform.deepseek.com".to_string()]),
                        }]),
                        open: Some(vec![OpenOperation {
                            ref_id: "https://platform.deepseek.com),
                            lineno: Some(12),
                        }]),
                        ..Default::default()
                    }),
                    settings: Some(SearchSettings {
                        ...
                        filters: Some(SearchFilters {
                            allowed_domains: Some(vec!["platform.deepseek.com".to_string()]),
            ...
            &json!({
                ...
                "commands": {
                    "search_query": [{
                        "q": "DeepSeek news",
                        "recency": 7,
                        "domains": ["platform.deepseek.com"]
                    }],
                    "open": [{"ref_id": "https://platform.deepseek.com "lineno": 12}]
                },
                "settings": {
                    "user_location": {
                        "type": "approximate",
