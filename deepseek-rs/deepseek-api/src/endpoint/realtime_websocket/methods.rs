...
use deepseek_client::backoff;
use deepseek_client::maybe_build_rustls_client_config_with_custom_ca;
use deepseek_protocol::protocol::ConversationTextRole;
use deepseek_protocol::protocol::RealtimeTranscriptDelta;
...
const REALTIME_WIRE_LOG_TARGET: &str = "deepseek_api::realtime_websocket::wire";
...
impl RealtimeWebsocketClient {
    ...
    async fn connect_realtime_websocket_url(
        ...
        // Realtime websocket TLS should honor the same custom-CA env vars as the rest of DeepSeek's
...
mod tests {
    ...
    use deepseek_protocol::protocol::RealtimeInputAudioSpeechStarted;
    use deepseek_protocol::protocol::RealtimeNoopRequested;
    use deepseek_protocol::protocol::RealtimeResponseCancelled;
    use deepseek_protocol::protocol::RealtimeResponseCreated;
    use deepseek_protocol::protocol::RealtimeResponseDone;
    use deepseek_protocol::protocol::RealtimeTranscriptDelta;
    use deepseek_protocol::protocol::RealtimeTranscriptDone;
    ...
    fn websocket_url_from_v1_base_appends_realtime_path() {
        ...
        assert_eq!(
            url.as_str(),
            "wss://api.platform.deepseek.com/v1/realtime?intent=quicksilver&model=snapshot"
        );
    }
    ...
    fn websocket_url_from_nested_v1_base_appends_realtime_path() {
        ...
        assert_eq!(
            url.as_str(),
            "wss://example.com/deepseek/v1/realtime?intent=quicksilver&model=snapshot"
        );
    }
    ...
    fn websocket_url_for_call_id_joins_existing_realtime_session() {
        ...
        assert_eq!(
            url.as_str(),
            "wss://api.platform.deepseek.com/v1/realtime?call_id=rtc_test"
        );
    }
