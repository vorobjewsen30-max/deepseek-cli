...
use deepseek_network_proxy::is_managed_mitm_ca_trust_bundle_path;
    ...
    let request = sandbox_manager
        .transform_for_direct_spawn(SandboxDirectSpawnTransformRequest {
            ...
            windows_sandbox_proxy_settings_mode:
                deepseek_sandboxing::WindowsSandboxProxySettingsMode::Reconcile,
            transform: SandboxTransformRequest {
                ...
                network: None,
                sandbox_policy_cwd,
                deepseek_linux_sandbox_exe: runtime_paths.deepseek_linux_sandbox_exe.as_deref(),
