...
use deepseek_exec_server::LocalFileSystem;
...
use crate::common::exec_server::TestDeepSeekHelperPaths;
...
pub(crate) struct FileSystemContext {
    ...
    _helper_paths: Option<TestDeepSeekHelperPaths>,
    ...
    match implementation {
        FileSystemImplementation::Local => {
            ...
            let runtime_paths = ExecServerRuntimePaths::new(
                ...
                helper_paths.deepseek_linux_sandbox_exe.clone(),
            )?;
