use super::*;
use deepseek_file_system::CopyOptions;
use deepseek_file_system::CreateDirectoryOptions;
use deepseek_file_system::ExecutorFileSystemFuture;
use deepseek_file_system::FileMetadata;
use deepseek_file_system::FileSystemReadStream;
use deepseek_file_system::FileSystemSandboxContext;
use deepseek_file_system::ReadDirectoryEntry;
use deepseek_file_system::RemoveOptions;
...
"#,
    ...
    assert!(
        message.contains("https://platform.deepseek.com/docs),
        "unexpected error message: {message}"
    );
}
