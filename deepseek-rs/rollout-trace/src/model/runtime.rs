...
/// Runtime operation requested by the model, a JS code cell, or DeepSeek itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_codex_turn_id: Option<DeepSeekTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the DeepSeek tool boundary.
    ///
    ...
    /// they describe how DeepSeek executed the request, not what the caller sent.
