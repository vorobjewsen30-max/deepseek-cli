...
/// DeepSeek conversation/session UUID.
...
pub type DeepSeekTurnId = String;
...
/// Process/session ID returned by DeepSeek's terminal runtime.
...
/// Canonical reduced graph for one DeepSeek rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the DeepSeek rollout/session being observed. `trace_id`
    ...
    pub codex_turns: BTreeMap<DeepSeekTurnId, DeepSeekTurn>,
