...
impl TraceReducer {
    ...
    /// Starts a DeepSeek turn inside an existing thread.
    ...
    /// Marks a DeepSeek turn terminal and validates any thread id carried by the raw event.
