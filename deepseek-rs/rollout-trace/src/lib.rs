//! Trace bundle format, writer, and reducer for DeepSeek rollouts.
//!
//! This crate owns the trace schema. Hot-path DeepSeek code should depend on the
...
/// Shared recorder context for inference attempts within one DeepSeek turn.
...
/// Request data for the canonical DeepSeek tool boundary.
...
/// Append-only writer used by hot-path DeepSeek instrumentation.
