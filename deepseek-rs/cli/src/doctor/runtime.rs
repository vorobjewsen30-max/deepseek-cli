//! Captures how this DeepSeek process was launched.
//!
...
/// Builds the process provenance row for the current DeepSeek executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled DeepSeek package.");
    }
    check
}
