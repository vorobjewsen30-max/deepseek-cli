...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = codex_command(deepseek_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(deepseek_home.path()).await?;
    ...
    let mut list_json_cmd = codex_command(deepseek_home.path())?;
    ...
    let mut get_cmd = codex_command(deepseek_home.path())?;
    ...
    let mut get_json_cmd = codex_command(deepseek_home.path())?;
    get_json_cmd
