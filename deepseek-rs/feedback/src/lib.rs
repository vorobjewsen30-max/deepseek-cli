...
pub fn emit_feedback_request_tags_with_auth_env(
    ...
    tracing::info!(
        ...
        auth_recovery_followup_success = tracing::field::debug(&snapshot.auth_recovery_followup_success),
        auth_recovery_followup_status = tracing::field::debug(&snapshot.auth_recovery_followup_status),
        auth_env_deepseek_api_key_present = tracing::field::debug(auth_env.deepseek_api_key_env_present),
        auth_env_deepseek_api_key_present = tracing::field::debug(auth_env.deepseek_api_key_env_present),
        auth_env_deepseek_api_key_enabled = tracing::field::debug(auth_env.deepseek_api_key_env_enabled),
...
#[derive(Clone)]
pub struct DeepSeekFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for DeepSeekFeedback {
    fn default() -> Self {
        Self::new()
    }
}

impl DeepSeekFeedback {
    pub fn new() -> Self {
...
impl FeedbackSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("deepseek-feedback-{}.log", self.thread_id);
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = DeepSeekFeedback::with_capacity(/*max_bytes*/ 8);
        {
    ...
    fn feedback_attachments_gate_connectivity_diagnostics() {
        let extra_filename = format!("deepseek-feedback-extra-{}.jsonl", ThreadId::new());
        ...
        let snapshot_with_diagnostics = DeepSeekFeedback::new()
        ...
        let attachments_without_diagnostics = DeepSeekFeedback::new()
            .snapshot(/*session_id*/ None)
    ...
    fn path_backed_attachments_use_binary_content_types() {
        ...
        let unknown_filename = format!("deepseek-feedback-extra-{suffix}.binunknown");
        ...
        let attachments = DeepSeekFeedback::new()
            .snapshot(/*session_id*/ None)
