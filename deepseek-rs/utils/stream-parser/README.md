# deepseek-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and DeepSeek did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust DeepSeek on it. Feel free to update the documentation as you
modify the code
...
```rust
use deepseek_utils_stream_parser::CitationStreamParser;
use deepseek_utils_stream_parser::StreamTextParser;
...
```rust
use deepseek_utils_stream_parser::CitationStreamParser;
use deepseek_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), deepseek_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use deepseek_utils_stream_parser::InlineHiddenTagParser;
use deepseek_utils_stream_parser::InlineTagSpec;
use deepseek_utils_stream_parser::StreamTextParser;
