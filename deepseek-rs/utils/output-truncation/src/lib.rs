//! Helpers for truncating tool and exec output using [`TruncationPolicy`](deepseek_protocol::protocol::TruncationPolicy).

use deepseek_protocol::models::FunctionCallOutputContentItem;
pub use deepseek_utils_string::approx_bytes_for_tokens;
pub use deepseek_utils_string::approx_token_count;
pub use deepseek_utils_string::approx_tokens_from_byte_count;
use deepseek_utils_string::truncate_middle_chars;
use deepseek_utils_string::truncate_middle_with_token_budget;

pub use deepseek_protocol::protocol::TruncationPolicy;
