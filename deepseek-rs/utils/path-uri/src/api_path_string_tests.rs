...
fn from_path_preserves_foreign_absolute_path_for_uri_conversion() {
    #[cfg(not(windows))]
    let (foreign_path, expected_uri) = (r"C:\Users\deepseek\share", "file:///C:/Users/deepseek/share");
    #[cfg(windows)]
    let (foreign_path, expected_uri) = ("/home/deepseek/share", "file:///home/deepseek/share");
