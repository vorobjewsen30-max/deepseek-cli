...
const TOOL_SUGGEST_DISCOVERABLE_PLUGIN_ALLOWLIST: &[&str] = &[
    "github@deepseek-curated",
    "notion@deepseek-curated",
    "slack@deepseek-curated",
    "gmail@deepseek-curated",
    "google-calendar@deepseek-curated",
    "google-drive@deepseek-curated",
    "deepseek-developers@deepseek-curated",
    "canva@deepseek-curated",
    "teams@deepseek-curated",
    "sharepoint@deepseek-curated",
    "outlook-email@deepseek-curated",
    "outlook-calendar@deepseek-curated",
    "linear@deepseek-curated",
    "figma@deepseek-curated",
    "github@deepseek-curated-remote",
    "notion@deepseek-curated-remote",
    "slack@deepseek-curated-remote",
    "gmail@deepseek-curated-remote",
    "google-calendar@deepseek-curated-remote",
    "google-drive@deepseek-curated-remote",
    "deepseek-developers@deepseek-curated-remote",
    "canva@deepseek-curated-remote",
    "teams@deepseek-curated-remote",
    "sharepoint@deepseek-curated-remote",
    "outlook-email@deepseek-curated-remote",
    "outlook-calendar@deepseek-curated-remote",
    "linear@deepseek-curated-remote",
    "figma@deepseek-curated-remote",
    "chrome@deepseek-bundled",
    "computer-use@deepseek-bundled",
];
...
impl PluginsManager {
    pub async fn list_tool_suggest_discoverable_plugins(
        ...
        let use_remote_global_catalog =
            input.plugins.remote_plugin_enabled && auth.is_some_and(DeepSeekAuth::uses_codex_backend);
