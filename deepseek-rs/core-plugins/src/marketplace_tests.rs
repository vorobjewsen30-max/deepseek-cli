  ...
  "plugins": [
    {
      ...
      "source": {
        "source": "git-subdir",
        "url": "deepseek/joey_marketplace3",
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            ...
            source: MarketplacePluginSource::Git {
                url: "https://github.com/deepseek/joey_marketplace3.git".to_string(),
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            ...
            source: MarketplacePluginSource::Npm {
                package: "@acme/deepseek-plugin".to_string(),
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        MarketplacePluginSource::Git {
            url: "https://github.com/deepseek/toolkit.git".to_string(),
            path: Some("plugins/toolkit".to_string()),
            ref_name: None,
            sha: None,
        }
...
fn list_marketplaces_supports_repo_root_local_plugin_sources() {
    for path in [".", "./"] {
        ...
        fs::create_dir_all(repo_root.join(".git")).unwrap();
        fs::create_dir_all(repo_root.join(".agents/plugins")).unwrap();
        fs::create_dir_all(repo_root.join(".deepseek-plugin")).unwrap();
        fs::write(
            repo_root.join(".agents/plugins/marketplace.json"),
            format!(
                r#"{{
  ...
  "plugins": [
    {{
      ...
      "source": {{
        ...
        .unwrap();
        fs::write(
            repo_root.join(".deepseek-plugin/plugin.json"),
            r#"{
  "name":"repo-root-plugin",
  "interface": {
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        Some(MarketplaceInterface {
            display_name: Some("DeepSeek Official".to_string()),
        })
    );
}
...
fn list_marketplaces_resolves_plugin_interface_paths_to_absolute() {
  ...
  "interface": {
    ...
    assert_eq!(
        ...
        Some(vec![Product::DeepSeek, Product::Chatgpt, Product::Atlas])
    );
    assert_eq!(
