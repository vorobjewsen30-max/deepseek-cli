...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        deepseek_home: PathBuf::from(r"C:\Users\codex"),
        ...
        spawn_request: SpawnRequest {
            ...
            deepseek_home: PathBuf::from(r"C:\Users\codex\.sandbox"),
            real_deepseek_home: PathBuf::from(r"C:\Users\codex"),
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        deepseek_home: request.deepseek_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |deepseek_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
