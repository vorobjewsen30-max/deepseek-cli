...
const SESSION_NAME: &str = "DeepSeek Windows Sandbox WFP";
const PROVIDER_NAME: &str = "DeepSeek Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for DeepSeek Windows sandbox filters";
const SUBLAYER_NAME: &str = "DeepSeek Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for DeepSeek Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are DeepSeek-owned identities; do not regenerate them unless we
...
/// Installs the persistent DeepSeek WFP filters for `account`.
///
...
/// Ensures the persistent DeepSeek WFP provider exists.
...
/// Ensures the persistent DeepSeek sublayer exists under the DeepSeek provider.
