//! DeepSeek Apps support for the host-owned apps MCP server.
//!
//! This module owns the normalization that turns DeepSeek-hosted app
//! connector/tool metadata into model-visible MCP callable names.

use deepseek_utils_plugins::mcp_connector::sanitize_name;
