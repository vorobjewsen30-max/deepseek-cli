...
//!
//! RMCP clients call into this module when a server asks DeepSeek to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a DeepSeek protocol event
...
use deepseek_rmcp_client::SendElicitation;
...
/// generated by DeepSeek rather than copied from the MCP connection, so separate runtimes may reuse
