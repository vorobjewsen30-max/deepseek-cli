...
pub fn declared_deepseek_file_input_param_names(
...
pub(crate) fn tool_with_model_visible_input_schema(tool: &Tool) -> Tool {
    let file_params = declared_deepseek_file_input_param_names(tool.meta.as_deref());
...
const META_OPENAI_FILE_PARAMS: &str = "deepseek/fileParams";
