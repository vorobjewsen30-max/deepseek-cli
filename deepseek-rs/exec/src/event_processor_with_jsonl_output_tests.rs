...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        deepseek_app_server_protocol::TurnCompletedNotification {
            ...
            turn: deepseek_app_server_protocol::Turn {
                ...
                error: Some(deepseek_app_server_protocol::TurnError {
    ...
    assert_eq!(status, DeepSeekStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        deepseek_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "DeepSeek CLI documentation"}]}),
                app_context: None,
                mcp_app_resource_uri: None,
                plugin_id: None,
                result: Some(Box::new(deepseek_app_server_protocol::McpToolCallResult {
