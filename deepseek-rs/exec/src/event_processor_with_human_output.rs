...
use deepseek_protocol::num_format::format_with_separators;
use deepseek_protocol::protocol::SessionConfiguredEvent;
use deepseek_utils_sandbox_summary::summarize_permission_profile;
use owo_colors::OwoColorize;
use owo_colors::Style;

use crate::event_processor::DeepSeekStatus;
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn process_server_notification(&mut self, notification: ServerNotification) -> DeepSeekStatus {
        match notification {
            ...
            ServerNotification::TurnPlanUpdated(notification) => {
                ...
                for step in notification.plan {
                    match step.status {
                        ...
                        deepseek_app_server_protocol::TurnPlanStepStatus::InProgress => {
                            eprintln!("  {} {}", "→".style(self.cyan), step.step);
                        }
                        deepseek_app_server_protocol::TurnPlanStepStatus::Pending => {
                            eprintln!(
                                "  {} {}",
                                "•".style(self.dimmed),
            ...
            ServerNotification::TurnStarted(_) => DeepSeekStatus::Running,
