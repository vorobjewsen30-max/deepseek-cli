...
#[command(
    version,
    override_usage = "deepseek exec [OPTIONS] [PROMPT]\n       codex exec [OPTIONS] <COMMAND> [ARGS]"
)]
pub struct Cli {
    ...
    /// Allow running DeepSeek outside a Git repository.
    ...
    /// Do not load `$DEEPSEEK_HOME/config.toml`; auth still uses `DEEPSEEK_HOME`.
