use deepseek_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use deepseek_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use deepseek_app_server_protocol::CollabAgentTool;
use deepseek_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use deepseek_app_server_protocol::CommandAction;
use deepseek_app_server_protocol::CommandExecutionSource;
use deepseek_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use deepseek_app_server_protocol::ErrorNotification;
use deepseek_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use deepseek_app_server_protocol::ItemCompletedNotification;
use deepseek_app_server_protocol::ItemStartedNotification;
use deepseek_app_server_protocol::McpToolCallError;
use deepseek_app_server_protocol::McpToolCallResult;
use deepseek_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use deepseek_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use deepseek_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use deepseek_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use deepseek_exec::AgentMessageItem;
use deepseek_exec::DeepSeekStatus;
use deepseek_exec::CollabAgentState;
use deepseek_exec::CollabAgentStatus;
use deepseek_exec::CollabTool;
use deepseek_exec::CollabToolCallItem;
use deepseek_exec::CollabToolCallStatus;
use deepseek_exec::CollectedThreadEvents;
use deepseek_exec::CommandExecutionItem;
use deepseek_exec::CommandExecutionStatus;
use deepseek_exec::ErrorItem;
use deepseek_exec::EventProcessorWithJsonOutput;
use deepseek_exec::ExecThreadItem;
use deepseek_exec::FileChangeItem;
use deepseek_exec::FileUpdateChange as ExecFileUpdateChange;
use deepseek_exec::ItemCompletedEvent;
use deepseek_exec::ItemStartedEvent;
use deepseek_exec::ItemUpdatedEvent;
use deepseek_exec::McpToolCallItem;
use deepseek_exec::McpToolCallItemError;
use deepseek_exec::McpToolCallItemResult;
use deepseek_exec::McpToolCallStatus;
use deepseek_exec::PatchApplyStatus;
use deepseek_exec::PatchChangeKind;
use deepseek_exec::ReasoningItem;
use deepseek_exec::ThreadErrorEvent;
use deepseek_exec::ThreadEvent;
use deepseek_exec::ThreadItemDetails;
use deepseek_exec::ThreadStartedEvent;
use deepseek_exec::TodoItem;
use deepseek_exec::TodoListItem;
use deepseek_exec::TurnCompletedEvent;
use deepseek_exec::TurnFailedEvent;
use deepseek_exec::TurnStartedEvent;
use deepseek_exec::Usage;
use deepseek_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        approvals_reviewer: deepseek_protocol::config_types::ApprovalsReviewer::User,
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: DeepSeekStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            deepseek_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, DeepSeekStatus::Running);
    ...
    assert_eq!(collected.status, DeepSeekStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        deepseek_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: deepseek_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
