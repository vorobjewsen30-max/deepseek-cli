#![cfg(unix)]
use deepseek_core::spawn::StdioPolicy;
...
async fn spawn_command_under_sandbox(
    ...
    use deepseek_core::exec::build_exec_request;
...
async fn spawn_command_under_sandbox(
    ...
    use deepseek_core::spawn_command_under_linux_sandbox;

    let deepseek_linux_sandbox_exe = core_test_support::find_deepseek_linux_sandbox_exe()
