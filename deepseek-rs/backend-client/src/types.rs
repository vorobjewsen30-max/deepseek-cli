pub use deepseek_backend_openapi_models::models::ConfigBundleResponse;
pub use deepseek_backend_openapi_models::models::CreditStatusDetails;
pub use deepseek_backend_openapi_models::models::DeliveredConfigToml;
pub use deepseek_backend_openapi_models::models::DeliveredRequirementsToml;
pub use deepseek_backend_openapi_models::models::DeliveredTomlFragment;
pub use deepseek_backend_openapi_models::models::PaginatedListTaskListItem;
pub use deepseek_backend_openapi_models::models::PlanType;
pub use deepseek_backend_openapi_models::models::RateLimitReachedKind;
pub use deepseek_backend_openapi_models::models::RateLimitStatusDetails;
pub use deepseek_backend_openapi_models::models::RateLimitStatusPayload;
pub use deepseek_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use deepseek_backend_openapi_models::models::SpendControlLimitDetails;
pub use deepseek_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct DeepSeekWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<DeepSeekWorkspaceMessage>,
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct DeepSeekWorkspaceMessage {
    pub message_id: String,
    pub message_type: DeepSeekWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum DeepSeekWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: DeepSeekWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            DeepSeekWorkspaceMessagesResponse {
                messages: vec![
                    DeepSeekWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: DeepSeekWorkspaceMessageType::Headline,
                    ...
                    DeepSeekWorkspaceMessage {
                        ...
                        message_type: DeepSeekWorkspaceMessageType::Announcement,
                    ...
                    DeepSeekWorkspaceMessage {
                        ...
                        message_type: DeepSeekWorkspaceMessageType::Unknown,
