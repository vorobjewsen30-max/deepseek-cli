...
use deepseek_app_server_protocol::RemoteControlDisableParams;
use deepseek_app_server_protocol::RemoteControlDisableResponse;
use deepseek_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<deepseek_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_DEEPSEEK_HOME: &str = "/tmp/deepseek-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "deepseek_app_server/1.2.3",
                    "codexHome": TEST_DEEPSEEK_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
