...
use deepseek_api::ImageBackground;
use deepseek_api::ImageEditRequest;
use deepseek_api::ImageGenerationRequest;
use deepseek_api::ImageQuality;
use deepseek_api::ImageUrl;
use deepseek_core::context::extension_image_generation_output_hint;
use deepseek_core::image_generation_artifact_path;
...
use deepseek_extension_api::ExtensionTurnItem;
use deepseek_extension_api::FunctionCallError;
use deepseek_extension_api::ToolCall;
use deepseek_extension_api::ToolEnvironment;
...
use deepseek_extension_api::parse_tool_input_schema;
use deepseek_protocol::items::ImageGenerationItem;
...
use deepseek_utils_image::PromptImageMode;
use deepseek_utils_image::load_for_prompt_bytes;
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    fn handle(&self, call: ToolCall) -> deepseek_extension_api::ToolExecutorFuture<'_> {
