...
use deepseek_extension_api::ThreadIdleInput;
...
use deepseek_extension_api::TokenUsageContributor;
...
use deepseek_extension_api::ToolLifecycleContributor;
use deepseek_extension_api::ToolLifecycleFuture;
use deepseek_extension_api::TurnAbortInput;
use deepseek_extension_api::TurnErrorInput;
use deepseek_extension_api::TurnLifecycleContributor;
    ...
    fn on_turn_error<'a>(&'a self, input: TurnErrorInput<'a>) -> ExtensionFuture<'a, ()> {
        Box::pin(async move {
            ...
            let reason = match input.error {
                DeepSeekErrorInfo::UsageLimitExceeded => ActiveGoalStopReason::UsageLimit,
