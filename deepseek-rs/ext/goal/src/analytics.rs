...
use deepseek_analytics::DeepSeekGoalEvent;
use deepseek_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &deepseek_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(DeepSeekGoalEvent {
