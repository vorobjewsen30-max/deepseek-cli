use deepseek_connectors_extension::ExecutorPluginConnectorProvider;
use deepseek_core::config::Config;
use deepseek_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, deepseek_config::McpServerConfig)>,
