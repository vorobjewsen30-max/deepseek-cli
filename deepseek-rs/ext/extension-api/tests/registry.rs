...
use deepseek_extension_api::ApprovalReviewContributor;
use deepseek_extension_api::ConfigContributor;
use deepseek_extension_api::ContextContributor;
use deepseek_extension_api::ContextualUserFragment;
...
use deepseek_extension_api::TurnInputContributor;
...
use deepseek_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: deepseek_protocol::ThreadId::default(),
