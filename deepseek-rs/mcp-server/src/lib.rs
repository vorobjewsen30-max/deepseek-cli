...
pub use crate::codex_tool_config::DeepSeekToolCallParam;
pub use crate::codex_tool_config::DeepSeekToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "deepseek_mcp_server";
...
pub async fn run_main(
    ...
    let environment_manager = Arc::new(
        EnvironmentManager::from_deepseek_home(
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = deepseek_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
