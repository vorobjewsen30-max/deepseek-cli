...
//! `schemars`) so they can be embedded in DeepSeek's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `deepseek-protocol` so other crates can convert
