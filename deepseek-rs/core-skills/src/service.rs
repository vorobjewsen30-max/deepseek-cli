...
use deepseek_config::SkillsConfig;
...
impl SkillsService {
    pub fn new(deepseek_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(deepseek_home, bundled_skills_enabled, Some(Product::DeepSeek))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&service.deepseek_home);
        } else if let Err(err) = install_system_skills(&service.deepseek_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &deepseek_config::ConfigLayerStack,
) -> bool {
