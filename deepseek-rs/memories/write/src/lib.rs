//! Write-path implementation for DeepSeek memories.
//!
...
mod stage_one {
    pub(super) const REASONING_EFFORT: deepseek_protocol::deepseek_models::ReasoningEffort =
        deepseek_protocol::deepseek_models::ReasoningEffort::Low;
...
mod stage_two {
    pub(super) const REASONING_EFFORT: deepseek_protocol::deepseek_models::ReasoningEffort =
        deepseek_protocol::deepseek_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
