...
from deepseek_codex._goal import _GoalNotificationStream
from deepseek_codex._run import _collect_turn_result
from deepseek_codex.generated.notification_registry import notification_turn_id
from deepseek_codex.generated.v2_all import TurnStatus
...
def test_private_goal_operation_coalesces_runtime_continuations(tmp_path) -> None:
    ...
    with AppServerHarness(tmp_path) as harness:
        ...
        with DeepSeek(config=harness.app_server_config()) as codex:
