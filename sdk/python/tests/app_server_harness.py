...
from deepseek_codex import DeepSeekConfig
...
class AppServerHarness:
    ...
    def __init__(self, tmp_path: Path, *, requires_deepseek_auth: bool = False) -> None:
        self.tmp_path = tmp_path
        self.deepseek_home = tmp_path / "deepseek-home"
        self.workspace = tmp_path / "workspace"
        self.requires_deepseek_auth = requires_deepseek_auth
        self.responses = MockResponsesServer()

    def __enter__(self) -> AppServerHarness:
        self.deepseek_home.mkdir()
    ...
    def __exit__(self, _exc_type: object, _exc: object, _tb: object) -> None:
        ...
        shutil.rmtree(self.deepseek_home, ignore_errors=True)
        shutil.rmtree(self.workspace, ignore_errors=True)

    def app_server_config(self) -> DeepSeekConfig:
    ...
    def _write_config(self) -> None:
        ...
        config_toml = self.deepseek_home / "config.toml"
        requires_deepseek_auth = "requires_deepseek_auth = true\n" if self.requires_deepseek_auth else ""
