...
GENERATED_TARGETS = [
    Path("src/deepseek_codex/generated/notification_registry.py"),
    Path("src/deepseek_codex/generated/v2_all.py"),
    Path("src/deepseek_codex/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("deepseek-cli-cli-bin") == "0.137.0a4"
    env = os.environ.copy()
