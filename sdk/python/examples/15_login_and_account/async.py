...
from deepseek_codex import AsyncDeepSeek


async def main() -> None:
    async with AsyncDeepSeek(config=runtime_config()) as codex:
        ...
        print("account.requires_deepseek_auth:", account.requires_deepseek_auth)
