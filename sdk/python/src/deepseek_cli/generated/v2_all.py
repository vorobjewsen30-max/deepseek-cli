...
#   filename:  deepseek_app_server_protocol.v2.schemas.json
...
class DeepSeekAppServerProtocolV2(BaseModel):
    pass
...
class DeepSeekErrorInfoValue(Enum):
...
class HttpConnectionFailedDeepSeekErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedDeepSeekErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedDeepSeekErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsDeepSeekErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_codex_folder: Annotated[AbsolutePathBuf, Field(alias="dotDeepSeekFolder")]
...
class ForcedChatgptWorkspaceIds(RootModel[str | list[str]]):
    ...
    root: Annotated[
        str | list[str],
        Field(
            description="Backward-compatible API shape for DeepSeek workspace login restrictions."
        ),
    ]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, DeepSeek attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class ReasoningSummary(RootModel[ReasoningSummaryValue | Literal["none"]]):
    ...
    root: Annotated[
        ...
        Field(
            description="A summary of the reasoning performed by the model. This can be useful for debugging and understanding the model's reasoning process. See https://platform.platform.deepseek.com/docs/guides/reasoning?api-mode=responses#reasoning-summaries"
        ),
    ]
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `deepseek_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableDeepSeekErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class DeepSeekErrorInfo(
    RootModel[
        DeepSeekErrorInfoValue
        | HttpConnectionFailedDeepSeekErrorInfo
        | ResponseStreamConnectionFailedDeepSeekErrorInfo
        | ResponseStreamDisconnectedDeepSeekErrorInfo
        | ResponseTooManyFailedAttemptsDeepSeekErrorInfo
        | ActiveTurnNotSteerableDeepSeekErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class GetAccountResponse(BaseModel):
    ...
    requires_deepseek_auth: Annotated[bool, Field(alias="requiresOpenaiAuth")]
...
class TurnError(BaseModel):
    ...
    codex_error_info: Annotated[DeepSeekErrorInfo | None, Field(alias="codexErrorInfo")] = None
    message: str
...
class Thread(BaseModel):
    ...
    model_provider: Annotated[
        ...
        Field(
            alias="modelProvider",
            description="Model provider used for this thread (for example, 'deepseek').",
        ),
    ]
