"""Command-line interface for building DeepSeek package directories."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a canonical DeepSeek package directory and optional archive.",
...
def main() -> int:
    ...
    for archive_output in args.archive_output:
        ...
        print(f"Built DeepSeek package archive at {archive_path}")

    print(f"Built DeepSeek package directory at {package_dir}")
    return 0
