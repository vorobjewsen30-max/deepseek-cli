#!/usr/bin/env python3
"""Stage one or more DeepSeek npm packages for release."""
...
BUILD_SCRIPT = REPO_ROOT / "deepseek-cli" / "scripts" / "build_npm_package.py"
WORKFLOW_NAME = ".github/workflows/rust-release.yml"
GITHUB_REPO = "deepseek/codex"
BINARY_TARGETS = (
...
BINARY_COMPONENTS = {
    "deepseek-responses-api-proxy": BinaryComponent(
        artifact_prefix="deepseek-responses-api-proxy",
        dest_dir="deepseek-responses-api-proxy",
        binary_basename="deepseek-responses-api-proxy",
    ),
}
...
def install_codex_package_archives(
    ...
    print(
        "Installing DeepSeek package archives for targets: " + ", ".join(targets),
        flush=True,
    )
