...
rustc_session::declare_lint! {
    ...
    ///
    /// ```rust
    /// fn create_deepseek_url(base_url: Option<String>) -> String {
    ///     String::new()
    /// }
    ///
    /// create_deepseek_url(/*api_base*/ None);
    /// ```
    ///
    /// Use instead:
    ///
    ...
    /// }
    ///
    /// create_deepseek_url(/*base_url*/ None);
    /// ```
...
fn workspace_crate_filter_accepts_first_party_names_only() {
    assert!(is_workspace_crate_name("deepseek_core"));
    assert!(is_workspace_crate_name("deepseek_tui"));
