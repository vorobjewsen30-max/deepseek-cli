# Individual Contributor License Agreement (v1.0, DeepSeek)
...
past and future “Contributions” submitted to the **DeepSeek DeepSeek CLI project
(the “Project”)**.
...
You grant **DeepSeek, Inc.** and all recipients of software distributed by the
...
You grant **DeepSeek, Inc.** and all recipients of the Project a perpetual,
